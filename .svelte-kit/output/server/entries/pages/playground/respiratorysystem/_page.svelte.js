...
function _page($$payload) {
  ...
  $$payload.out += `<!----> <div id="wrapper" class="pageWrapper"><div class="savespaceTop"></div> <div><h5>Overview of the project</h5> <p class="twocoloumns svelte-36vdyo">Our goal was to create an interactive exhibition design centered
                ...
                has on their respiratory system.</p></div> `;
  Image($$payload, {
    src: "../images/Respiratory/project.png",
    caption: "Project at the exebition"
  });
  $$payload.out += `<!----> <div class="spacer svelte-36vdyo"></div> <div><h5>Technical Background</h5> <p class="twocoloumns svelte-36vdyo">The experience includes a pulse sensor that scans your
                ...
                representation of their lung activity in real-time.</p></div> <div class="spacer svelte-36vdyo"></div> <h5>The final exhibition setup</h5> `;
  YouTubeVideoEmbed($$payload, {
    url: RespiratoryVideourl,
    project: "Respiratory"
  });
