...
function _page($$payload) {
  ...
  let teamNames = [
    { name: "Mark Schade", portfolio: "mshd.de" },
    {
      name: "Julia Zöllner",
  ...
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>Tim Bluthardt | Growceries</title>`;
  });
  $$payload.out += `<main>`;
  ...
  $$payload.out += `<!----> <div class="pageWrapper"><div class="savespaceTop"></div> <div class="project_layout"><div class="txt"><h5>Outcome of a Design Sprint</h5> <p class="svelte-19hib0t">As part of a university project, this project focuses on the concept
  ...
  Image($$payload, {
    ...
    caption: "Google Design Sprint Struckture"
  });
  $$payload.out += `<!----> <div class="txt"><h5>What is Growceries?</h5> <p class="svelte-19hib0t">Growceries is a MVP, a platform where farmers can reach out to
                    ...
                    to have easier access to regional and ecological food.</p></div> `;
  Image($$payload, {
    src: "../images/Growceries/GrowFlow.png",
    caption: "Workflow of Growceries"
  });
  $$payload.out += `<!----> <div class="txt"><h5>Design Process</h5> <p class="svelte-19hib0t">First, we interviewed potential users to gain
                    ...
                    customer must be informed where to go ans pick up the goods.</p></div> <div class="txt"><div></div> <p class="svelte-19hib0t">Out of these insights we framed 'How might we' questions to clearly
                    ...
                    development of a final Minimum Viable Product (MVP).</p></div> <div class="txt"><h5>Branding</h5> <p class="svelte-19hib0t">To create a professional look for our app, we developed
                    ...
                    application.</p></div> <img src="../images/Growceries/GrowBranding.png" alt="Branding" class="svelte-19hib0t"> <div class="txt"><h5>Outcome of the project</h5> <p class="svelte-19hib0t">The result of the project is a fully functional prototype of the
                    ...
                    product with others. This helps to reduce food waste.</p></div> `;
  YouTubeVideoEmbed($$payload, {
    url: GrowceriesVideourl,
    project: "Growceries"
  });
  $$payload.out += `<!----></div></div> `;
